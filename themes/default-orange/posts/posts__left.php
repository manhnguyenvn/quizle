<div id="latest-posts-outer-container" data-in-progress="0" data-current-page="1" data-more-pages="<?= $__DATA['more_pages'] ?>" data-tag-id="<?= $__TAG_ID ?>" data-is-cat="<?= $__IS_CAT ?>">
    <div id="latest-posts-inner-container">
        ...
        $html .= '<div class="latest-post latest-post-create"><a href="' . LOCATION_SITE . 'user-quiz.php">' . $__LANGUAGE_STRINGS['home_page']['CREATE_OWN_POST'] . '</a></div>';
